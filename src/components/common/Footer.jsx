                    ...
                    <Grid item xs={ 12 } md={ 4 }>
                        <motion.div variants={footerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0}>
                            ...
                            <Typography variant="body2" sx={{opacity: 0.9}}>
                                Beauty that makes you glow. Your ultimate destination for premium beauty and grooming services.
                            </Typography>
                            <Box sx={ { mt: 2 } }>
                                <motion.div whileHover={{scale: 1.1}} whileTap={{scale: 0.9}}>
                                    <IconButton color="inherit" href="https://www.facebook.com/" target="_blank" aria-label="Facebook page" sx={{border: `1px solid ${theme.palette.primary.light}`, mr: 1}}>
                                        <FacebookIcon />
                                    </IconButton>
                                </motion.div>
                                <motion.div whileHover={{scale: 1.1}} whileTap={{scale: 0.9}}>
                                    <IconButton color="inherit" href="https://www.instagram.com/" target="_blank" aria-label="Instagram page" sx={{border: `1px solid ${theme.palette.primary.light}`}}>
                                        <InstagramIcon />
                                    </IconButton>
                                </motion.div>
                            </Box>
